  ...
  return (
    <div>
      <div className="mx-auto max-w-xl space-y-4">
        ...
        <Button onClick={handleGetSuggestions} disabled={isLoading} className="w-full" size="lg">
          {isLoading ? (
      ...
      {hasSearched && !isLoading && (
        <div className="mt-12">
          {suggestions.length > 0 ? (
            <div>
              <h3 className="text-2xl font-bold text-center mb-8">Here are your recommendations:</h3>
             ...
             <div className="text-center text-muted-foreground mt-8">
                <p>{error || 'No results to show yet. Try a new search!'}</p>
             </div>
          )}
        </div>
      )}
